...
#ifndef SIGCUE_SWIFT_H
#define SIGCUE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="sigcue",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC6sigcue30FocusCountdownWindowController")
@interface FocusCountdownWindowController : NSObject <NSWindowDelegate>
